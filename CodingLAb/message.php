			...
			<div class="user signinBx">
				...
				<div class="formBx">
					<form action="forgotfunc.php" method="post" id="logform">
						<h4>You will receive a message to your email and by clicking on the link you can change your password</h4>
						<p style="text-align:center;" class="signup"><a style="font-size: 16px;" href="registerpage.html">Go Back</a></p>
					</form>
				</div>
			</div>
	</section>
